...
curl -z CH32L103DS0.PDF -o CH32L103DS0.PDF https://file.wch.cn/download/file?id=452
# https://www.wch.cn/downloads/CH32L103RM_PDF.html
curl -z CH32L103RM.PDF -o CH32L103RM.PDF https://file.wch.cn/download/file?id=453
cd ..

# https://www.wch.cn/downloads/CH32L103EVT_ZIP.html
curl -z CH32L103EVT.ZIP -o CH32L103EVT.ZIP https://file.wch.cn/download/file?id=455
rm -rfv EVT
unzip -O GB2312 *.ZIP
