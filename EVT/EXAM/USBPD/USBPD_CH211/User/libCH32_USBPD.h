...
#define Check_CC_Valid		( !GPIO_ReadInputDataBit(GPIOB,PD_DEVICE.GpioCC) && ((*PD_DEVICE.PortCC)&PA_CC_AI) )	//µÍÓÚIOÇÒ¸ßÓÚCMP


//#define CC1_Float			{GPIOA->CFGLR&=~0xF00000;GPIOA->CFGLR|=0x400000;}    
//#define CC1_PushPull		{GPIOA->CFGLR&=~0xF00000;GPIOA->CFGLR|=0x100000;}    


#define tDRP				45		//45ms		(50~100)/2
#define tDRPTry			    140		//140ms		75~150

#define tCCDebounce		    110		//110ms		100~200
#define tPDDebounce		    10		//10ms		10~20
#define tTryCCDebounce		10		//10ms		10~20
#define tTryTimeout		    1100	//1100ms




//#define vSafe0V			140		//0.8V
////#define vSafe0V			400		//0.8V
//#define vSinkDisconnect  	645     //3.67V

#define vSafe0V             151     //0.8V
#define vSinkDisconnect     693     //3.67V
#define vVBUSon     		429     //2.27V

void Set_DevChk(u8 Role);
void Set_DevChk_HRST(void);
...
#define PD_SYS_TIMER			250		
#define PD_WaitGCRC_TIMER		300	
#define PD_GCRC_TIMER			15		
...
#define GetADC_VBUS                     ADC_Get_Sample(ADC_Channel_1)
...
extern st_PD_Settings PD_Settings;
