...
#define FLYSTARTPLL_BANDWIDTH_M          _IQ(0.35)

#define FLYSTART_VERIFY_NUM_M            10

#define FLYSTART_SPEED_LPF_CF_M          200
#define FLYSTART_SPEED_LPF_PERIOD_M      FLYSTART_PERIOD_M
...
#define FLYSTART_BREAKTIME               0.75
...
void Flystart_Process(Flystart_type *Flystart,int8_t Direction,Motor_Sructure_Type *MStruc,SVPWM_2R_Type *SVPWM_Cal,\
                      Motor_LBG_Type *MLBG,ADCStruc_Type *ADCStruc,Motor_PID_Type *Mpid);
void Flystart_Switch(Flystart_type *Flystart,Rampctr_Type *SpeedRamp);
void Flystart_CtrLoop_Inital(Flystart_type *Flystart,Motor_PID_Type *Mpid,\
                   Motor_Sructure_Type *MStruc,Motor_LBG_Type *MLBG,DCurrProcess_Type *DCurrProcess);
#endif
