...
#define SYSTEM_CLOCK_FREQ   96000000uL     // System clock Frequency (unit-Hz)
...
#define DEADTIME_SVPWM   500

#define DEADTIME_CONFIGURE  (uint16_t)(56)  //

#define BRK_GPIO_M    GPIOB
#define BRK_PIN_M     GPIO_Pin_12

#define CURR_SAMPLE_RESISTOR_ADC    _IQ16(0.1)
#define CURR_AMPLIFIER_ADC          _IQ16(3.7333)

#define CURR_SAMPLE_RANGE_ADC       _IQ16div(_IQ16(1.65),_IQ16mpy(CURR_SAMPLE_RESISTOR_ADC,CURR_AMPLIFIER_ADC))

#define SAMPLING_TIMER_CLOCK        ADC_SampleTime_CyclesMode1

#define CURR_OFFSET_READ_NUM_ADC    ((uint8_t)16)

#define CURR_CHANNEL_PHASEA_M         ADC_Channel_4

#define DCVOLT_INIT         _IQ(1.0)
#define DCVOLT_CONV_RATIO   _IQ16(0.166667)
