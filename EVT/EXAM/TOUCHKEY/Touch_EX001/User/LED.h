...
#define LED_SEG2_PIN	GPIO_Pin_12	//GPIOB
#define LED_SEG3_PIN	GPIO_Pin_14	//GPIOB
#define LED_SEG4_PIN	GPIO_Pin_10	//GPIOA
...
#define LED_COM1_PIN	GPIO_Pin_15	//GPIOB
#define LED_COM2_PIN	GPIO_Pin_13	//GPIOB
#define LED_COM3_PIN	GPIO_Pin_10	//GPIOD
#define LED_COM4_PIN	GPIO_Pin_9	//GPIOC
#define LED_COM5_PIN	GPIO_Pin_5	//GPIOC
