...
#define TKY_CHS_INIT \
				GEN_TKY_CH_INIT(TKY_QUEUE_0,0,49,16,0,3382,35,15),\
				GEN_TKY_CH_INIT(TKY_QUEUE_1,5,22,16,0,3223,150,120),\
				GEN_TKY_CH_INIT(TKY_QUEUE_2,7,29,16,0,3621,70,50),\
				GEN_TKY_CH_INIT(TKY_QUEUE_3,6,29,16,0,3600,70,50),\
				GEN_TKY_CH_INIT(TKY_QUEUE_4,4,30,16,0,3360,70,50),\
				GEN_TKY_CH_INIT(TKY_QUEUE_5,1,34,16,0,3233,70,50),\
				GEN_TKY_CH_INIT(TKY_QUEUE_6,3,28,16,0,3604,70,50),\
				GEN_TKY_CH_INIT(TKY_QUEUE_7,2,29,16,0,3214,75,50)
