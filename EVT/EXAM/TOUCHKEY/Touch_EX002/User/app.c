...
void TKY_dataProcess(void)
{
    ...
    {
       case KEY_NONE   :   break;
       case KEY_0_DOWN :   TKY_KeyBacklightOut(0,ENABLE);break;
       case KEY_0_LONG :   TKY_KeyBacklightOut(0,ENABLE);break;
       case KEY_0_UP   :   TKY_KeyBacklightOut(0,DISABLE);break;
       case KEY_1_DOWN :   TKY_KeyBacklightOut(1,ENABLE);break;
       case KEY_1_LONG :   TKY_KeyBacklightOut(1,ENABLE);break;
       case KEY_1_UP   :   TKY_KeyBacklightOut(1,DISABLE);break;
       case KEY_2_DOWN :   TKY_KeyBacklightOut(2,ENABLE);break;
       case KEY_2_LONG :   TKY_KeyBacklightOut(2,ENABLE);break;
       case KEY_2_UP   :   TKY_KeyBacklightOut(2,DISABLE);break;
       case KEY_3_DOWN :   TKY_KeyBacklightOut(3,ENABLE);break;
       case KEY_3_LONG :   TKY_KeyBacklightOut(3,ENABLE);break;
       case KEY_3_UP   :   TKY_KeyBacklightOut(3,DISABLE);break;
       case KEY_4_DOWN :   TKY_KeyBacklightOut(4,ENABLE);break;
       case KEY_4_LONG :   TKY_KeyBacklightOut(4,ENABLE);break;
       case KEY_4_UP   :   TKY_KeyBacklightOut(4,DISABLE);break;
       case KEY_5_DOWN :   TKY_KeyBacklightOut(5,ENABLE);break;
       case KEY_5_LONG :   TKY_KeyBacklightOut(5,ENABLE);break;
       case KEY_5_UP   :   TKY_KeyBacklightOut(5,DISABLE);break;
       case KEY_6_DOWN :   TKY_KeyBacklightOut(6,ENABLE);break;
       case KEY_6_LONG :   TKY_KeyBacklightOut(6,ENABLE);break;
       case KEY_6_UP   :   TKY_KeyBacklightOut(6,DISABLE);break;
       case KEY_7_DOWN :   TKY_KeyBacklightOut(7,ENABLE);break;
       case KEY_7_LONG :   TKY_KeyBacklightOut(7,ENABLE);break;
       case KEY_7_UP   :   TKY_KeyBacklightOut(7,DISABLE);break;
		default :  break;
    }
}
